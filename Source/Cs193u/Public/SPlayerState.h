...
UCLASS()
class CS193U_API ASPlayerState : public APlayerState
{
	GENERATED_BODY()
...
protected:
	...
	// Downside of using multicast here is that we send over more data over the net, since it's an RPC with two parameters. OnRep is "free" since Credits is already replicated anyway.
