...
UCLASS()
class CS193U_API ASPlayerController : public APlayerController
{
	GENERATED_BODY()
...
public:	
	...
	// afterwards player state will not change again as PlayerControllers maintain the same player satate throughout the level)
	UPROPERTY(BlueprintAssignable)
